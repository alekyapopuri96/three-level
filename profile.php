...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <script async="" src="https://connect.facebook.net/en_US/fbevents.js"></script><script src="https://www.google-analytics.com/ga.js"></script><script src="https://use.fonticons.com/webfontloader/1.6.24/webfontloader.js"></script><script src="https://use.fonticons.com/ffe176a3.js"></script>
  <script>
    var _gaq = _gaq || [];
...
<link rel="stylesheet" href="https://fonticons-free-fonticons.netdna-ssl.com/kits/ffe176a3/ffe176a3.css" media="all"><script id="_carbonads_projs" type="text/javascript" src="//srv.carbonads.net/ads/C6AILKT.json?segment=placement:fontawesome&amp;callback=_carbonads_go"></script><script id="_bsa_srv-CVADP2Y" type="text/javascript" src="http://inventory.fontawesome.io/api/inventory?zone=CVADP2Y&amp;callback=_bsa_go&amp;segment=placement%3Ademo"></script><script type="text/javascript" charset="utf-8" async="" src="https://platform.twitter.com/js/button.3943c052be33b5e812dac6838df9cb3d.js"></script><script type="text/javascript" src="//fallbacks.carbonads.com/home/e99a260b94849497ea962f674f0aebd9//fontawesome/8/"></script></head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
...
var url = "profiledbentry.php"; // the script where you handle the form input.
...
$.ajax({
 ...
 <body> <form  name="reg" action="profiledbentry.php" method="post" id="myform" >
<div class="container" >
    <div class="row">
        <section>
        <div class="wizard">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" role="tabpanel" id="step1">
                        <div class="step1">
							...
							<form  name="reg" action="profiledbentry.php" method="post" >
  <label for="exampleInputEmail1">First Name</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control" name="confirmemail" id="confemail" placeholder="Email"  onblur="confirmEmail()" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control" id="mobnum" name="mobnum" placeholder="mobileno">
                            </div>
                            <div class="col-md-6">
                            <label for="exampleInputEmail1">Address</label>
                                <div class="row">
                                    <div class="col-md-3 col-xs-3">
                                        <input type="email" class="form-control" id="houseno" name="houseno" placeholder="H.no:">
                                    </div>
                        ...
                        <hr>
                            ...
                            <div class="row mar_ned">
                                <div class="col-md-4 col-xs-3">
                                    <p align="right"><stong>Dob</stong></p>
                                </div>
                                <div class="col-md-8 col-xs-9">
                                    <div class="row">
                                        <div class="col-md-3 col-xs-3 wdth">
                                            <select name="dob" id="dob" class="dropselectsec1">
                            ...
                            <div class="row mar_ned">
                                <div class="col-md-4 col-xs-3">
                                    <p align="right"><stong>Gender</stong></p>
                                </div>
                                <div class="col-md-8 col-xs-9">
                                    <div class="row">
                                        <div class="col-md-6 col-xs-6 wdth">
                                           <input type="radio" value="female" id="female" checked>
                    ...
                    <div class="tab-pane" role="tabpanel" id="complete">
                        <div class="step44">
                            <h5>Thank you for filling your details
                            <button><a href="password">com</a></button></h5>
                        </div>
                    </div>
